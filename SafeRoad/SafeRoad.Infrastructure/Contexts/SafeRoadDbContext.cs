...
public class SafeRoadDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Incident>(entity =>
        {
            ...
            entity.Property(i => i.Location).HasColumnType("geography").IsRequired();
        ...
        modelBuilder.Entity<Municipality>(entity =>
        {
            ...
            entity.Property(m => m.Boundary).HasColumnType("geography");
        });
        ...
        modelBuilder.Entity<UserJourney>(entity =>
        {
            ...
            entity.Property(j => j.RoutePath).HasColumnType("geography").IsRequired();
        ...
        modelBuilder.Entity<WatchedArea>(entity =>
        {
            ...
            entity.Property(w => w.Area).HasColumnType("geography").IsRequired();
