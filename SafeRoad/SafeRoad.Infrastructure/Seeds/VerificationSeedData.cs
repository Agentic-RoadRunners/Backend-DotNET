...
public static class VerificationSeedData
{
    public static void Seed(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Verification>().HasData(
            ...
            new Verification { Id = 2, IncidentId = IncidentSeedData.Incident1Id, UserId = UserSeedData.AdminId, IsPositive = true, CreatedAt = new DateTime(2025, 1, 11, 12, 0, 0, DateTimeKind.Utc) },
